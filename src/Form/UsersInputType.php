 ...
 * Bootstrap-usersinput javascript plugin.
 *
...
class UsersInputType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->addModelTransformer(new UserArrayToStringTransformer($this->userRepository), true)
        ;
    }
    ...
    {
        $view->vars['users'] = $this->userRepository->findAll();
    }
